            ...
            <div className="relative mt-4">
                <div className='grid grid-cols-2 gap-6 '>
                    ...
                    <div className=' text-left text-gray-400 '>
                        ...
                        <select id="provinces" class="h-[50px] bg-gray-50 border border-gray-300 text-gray-900 text-xs lg:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                            <option value="Psychiatrists">MBBS</option>
                            <option value="Radiologists">MD</option>
                            <option value="Radiologists">DM</option>
                        </select>
                    </div>
                </div>
            </div>
            <div className="relative mt-4">
                <div className='grid grid-cols-1 gap-6 '>
                    <div className='text-left  text-gray-400 '>
                        ...
                        <div className='flex items-center'><SearchComponent /><h1 className='text-[35px] ml-2 mt-3 text-[#42ADF0]'><MdAddCircle /></h1></div>
                    </div>
                    <hr />
                    <div className="grid md:grid-cols-3 gap-2">
                        <div id="alert-1" class="flex p-4 mb-4 text-white bg-[#42ADF0] rounded-lg " role="alert">
                            ...
                            <button type="button" class="ml-auto -mx-1.5 -my-1.5 text-white-500 rounded-lg focus:ring-2  p-1.5  inline-flex h-8 w-8 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-1" aria-label="Close">
                        ...
                        <div id="alert-1" class="flex p-4 mb-4 text-white bg-[#42ADF0] rounded-lg " role="alert">
                            ...
                            <button type="button" class="ml-auto -mx-1.5 -my-1.5 text-white-500 rounded-lg focus:ring-2 focus:ring-blue-400 p-1.5  inline-flex h-8 w-8 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700" data-dismiss-target="#alert-1" aria-label="Close">
                                <span class="sr-only">Close</span>
                                <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                            </button>
                        </div>
