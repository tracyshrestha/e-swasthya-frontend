        ...
        <div className='p-4 flex flex-col justify-center items-center  '>
          ...
          <form className='border-[#f8f8f8] h-auto sm:w-[600px] h-auto w-[350px] items-center rounded-sm  p-9 m-8 mt-1 mx-24 bg-white mb-5'>
            ...
            <div className='items-center mb-5'>
              <h6 className='sm:text-[18px] text-[16px] sm:mb-[-8px] font-medium text-gray-500'>RESET PASSWORD</h6>
            ...
            <div class="pb-6">
              <div className='grid grid-cols-1 pb-2'>
                <div className=' text-left  text-gray-500 '>
                  <h1 className='sm:text-[15px] text-[12px]  relative text-gray-400'>Enter your new password</h1>
                </div>
              </div>

              <div class="relative">
                <input type="password" id="email-address-icon" class=" placeholder-gray-300 0 h-[50px] border border-gray-300 text-gray-900 text-[15px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-3 p-2.5  " placeholder="Password"></input>
              </div>
            </div>
            <div class="pb-6">
              <div className='grid grid-cols-1 pb-2'>
                <div className=' text-left  text-gray-500 '>
                  <h1 className='sm:text-[15px] text-[12px]  relative text-gray-400'>Reenter your password</h1>
                </div>
              </div>
              <div class="relative">
                <input type="password" id="email-address-icon" class=" placeholder-gray-300 0 h-[50px] border border-gray-300 text-gray-900 text-[15px] rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-3 p-2.5  " placeholder="Reenter password"></input>
              </div>
            </div>
