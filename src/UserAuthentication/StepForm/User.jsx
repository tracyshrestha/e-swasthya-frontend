...
const User = () => {
    ...
    return (
      ...
      <div className="drop-shadow-md w-max h-max items-center rounded-sm border-[2px] border-[#f8f8f8] p-10 sm:m-9 m-0 sm:mx-24 bg-white">
        ...
        </div>
        {
          formNo === 1 && <div>
            ...
            <div className='flex flex-col mb-2'>
              ...
              <div className='flex justify-center items-center'>
                {previewImage ? (
                  <img src={previewImage} alt="Selected Image" class="self-center h-[160px] p-5   mt-0 sm:mt-10 border border-gray-300  rounded-full" />
                ) : (
                  <img src={camera} alt="Placeholder Image" class="self-center h-[160px] p-5  mt-0 sm:mt-10 border border-gray-300  rounded-full" />
                )}
            ...
            <div className='flex flex-col mb-4 '>
              ...
              <div className='border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-700 focus:border-blue-500 block w-full  p-2.5'>
                ...
                <div className='text-base'>
                  <input type="radio" name="employeeStatus" id='male' value="male" checked={state.male} onChange={inputHandle} /> Male <br />
                  <input type="radio" name="employeeStatus" id='female' value="female" checked={state.female} onChange={inputHandle} /> Female <br />
                  <input type="radio" name="employeeStatus" id='other' value="other" checked={state.other} onChange={inputHandle} /> Other
                </div>
              </div>
            </div>
