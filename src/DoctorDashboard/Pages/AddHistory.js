...
import PescribeDrug from './PageComponents/Accordion/PescribeDrug'
                    ...
                    <div className=' grid md:grid-cols-1 sm:grid-cols-1  lg:grid-cols-2'>
                        ...
                        <div className='p-5'>
                            ...
                            <p class="text-xl p-3 mb-5 flex font-medium text-gray-900 truncate dark:text-white">
                                Prescribe Drugs  <button type="button" class="ml-2 flex items-center justify-center text-white bg-[#42ADF0]  rounded-full w-6 h-6">
