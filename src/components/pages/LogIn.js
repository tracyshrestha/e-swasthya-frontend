  ...
  return (
    <>
      <div className='fixed inset-0  h-screen backdrop-blur-sm flex  flex-col justify-center items-center bg-[#E6F4F9] '>
        ...
        <img src={logo} alt="" class="self-center h-[60px] pt-2" />
          </div>
        <form className='sm:h-[550px] sm:w-[600px] h-[505px] w-[350px] items-center rounded-sm border-[2px] border-[#f8f8f8] p-9 m-9 mt-4 mx-24 bg-white '>
          <div className='items-center'>
            ...
            <h6 className='sm:text-l text-[11px] sm:px-[100px] mx-7 sm:pb-9 pb-5 text-gray-400'>Enter your credintials to access your account.</h6>
          </div>
          ...
          <div className='flex flex-col items-center'>
            <button className='sm:w-[520px] w-[275px] text-center py-3 mt-8 font-bold  bg-[#42ADF0] hover:bg-[#4D6B9C] relative rounded-xl text-white hover:bold'>
              Sign In
            </button>
          </div>
          ...
          <div className=' text-center sm:mt-[25px] mt-5 text-gray-500 '>
            <p className='sm: text-l text-[14px] text-center '>Don't have an account?  <a className='sm:text-lg text-[16px] font-bold relative text-[#42ADF0] hover:text-[#4D6B9C] underline hover:decoration-solid   hover:uppercase' href="LogInUser">Sign up.</a></p>
