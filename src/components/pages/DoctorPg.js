    ...
    return (
        ...
        <div id='' className='h-full w-full flex-items-center text-grey-600 bg-[#42adf020] '>
                ...
                <div className='flex md:flex-row flex-col'>
                    ...
                    <div class="relative md:w-[330px] md:mt-5 mt-3 md:mx-0 mx-3">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <img src={search} alt="" class="self-center w-5 h-5 rounded-full mx-1" />
                        </div>
                        <input type="text" id="email-address-icon" class=" border text-gray-900 text-sm border-[#42adf051] boarder-opacity-60 rounded-lg w-full pl-4 p-2.5" placeholder="Search specialist" maxLength={14} />
                    </div>


                    <div class="relative md:w-[330px] md:mt-5 mt-3 mx-3">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                            <img src={pin} alt="" class="self-center w-5 h-5 rounded-full mx-1" />
                        </div>
                        <input type="text" id="email-address-icon" class="border text-gray-900 text-sm border-[#42adf051] boarder-opacity-60 rounded-lg w-full pl-4 p-2.5" placeholder="Search location" maxLength={14} />
                    </div>
            ...
            <div className=''>
                ...
                <div className='text-center text-2xl md:text-5xl pt-3 text-[#154768] font-bold' >
                    Doctors
                </div>
                ...
                <div className='xl:mx-6 mx-auto lg:mx-4 flex flex-wrap justify-center items-center'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 justify-center items-center sm:w-[470px] w-[290px] h-50 p-5 m-5 bg-white border-2 shadow-2xl cursor-pointer border-[#42adf051] boarder-opacity-60 rounded-lg  transistion duration-300 ease-in'>
                        ...
                        <div className='flex justify-center '>
                            <img src={doc1} alt="image" className=' sm:w-full w-[100px] p-2' />
                        </div>

                        <div className=' text-center'>
                            <h1 className='text-2xl font-semi-bold mb-3'> Dr. Rita Shrestha</h1>
                            <h2 className='leading-relaxed mb-3'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor </h2>
