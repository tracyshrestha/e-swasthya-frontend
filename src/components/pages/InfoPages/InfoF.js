  ...
  return (
    <div className="w-screen h-full pb-[20px} flex flex-col justify-center items-center  bg-[#E6F4F9]">
      ...
      <div className=" sm:h-full sm:w-[600px] h-[535px] w-[350px] items-center rounded-sm border-[2px] border-[#f8f8f8] p-9 sm:m-9 m-0 sm:mx-24 bg-white">
        <div className='flex justify-center items-center'>
          <h2 className='sm:text-[30px] text-[22px] font-bold  text-gray-700'>Fill in your informationp
          </h2>
        </div>
        <div className='flex justify-center items-center'>
          {
        ...
        </div>
        {
          formNo === 1 && <div>
            ...
            <div className='mt-0 sm:mt-10 flex justify-center items-center'>
              <button onClick={next} className='px-3 py-2 m-0 sm:mb-[50px] text-lg rounded-md w-full text-white bg-[#42ADF0]'>Next</button>
            </div>
          </div>
          </div>
        }
